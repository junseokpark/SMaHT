...
#RESULT_DIRECTORY=${BASE_DIRECTORY}/results/xTea/shortread/mosaic/mixedDataRetroSom/Simul100x
...
SAMPLE_DIRECTORY="/n/data1/bch/genetics/lee/projects/SMaHT/data/SMaHT_DAC_HapMap/illuminaNovaseq_bulkWgs_400x/500x_WashU"
